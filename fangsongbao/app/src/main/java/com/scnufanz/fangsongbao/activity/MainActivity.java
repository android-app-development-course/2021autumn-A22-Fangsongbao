package com.scnufanz.fangsongbao.activity;
...
import com.scnufanz.fangsongbao.fragment.MeFragment;
import com.scnufanz.fangsongbao.fragment.ParentFragment;
import com.scnufanz.fangsongbao.service.AutoUpdateService;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (login_type.equals("with_face")) {
			...
			user_name_tv.setText("用户:【张帆】");
			user_phone_tv.setText("手机:【13510627423】");
		}
